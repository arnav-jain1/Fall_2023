...
*Brushed*
Current provided with two magnetic brushes
...
**DAC vs PWM**
DAC used when sending information
PWM used for controlling power


**Servo motor**
Electrical device to control linear/angular position/velocity
